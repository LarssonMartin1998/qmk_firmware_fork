...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[RAISE] = LAYOUT(
        ...
        KC_F11,  _______, _______, _______, _______,    KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_F12,
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,      KC_F6,   KC_F7,   KC_F8,   KC_F9,    KC_F10,
                                   _______, _______,    KC_ENT,  KC_DEL
    ),
	[LOWER] = LAYOUT(
        KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,    KC_CIRC, KC_AMPR, KC_ASTR, KC_HOME,  KC_END,
        KC_LBRC, KC_LT,   KC_LPRN, KC_LCBR, KC_TILD,    KC_GRV,  KC_RCBR, KC_RPRN, KC_GT,    KC_RBRC,
        KC_QUOT, KC_BSLS, KC_MINS, KC_PLUS, _______,    _______, KC_EQL,  KC_UNDS, KC_PIPE,  KC_DQUO,
